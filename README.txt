This program will allow a user to choose a GitHub user name to search for and then it will display the basic details of that user in a web server that it creates.  The server runs at http://127.0.0.1 on port 8081 on the local machine the program is on.
